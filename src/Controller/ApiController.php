...
class ApiController extends Controller
{
    ...
    /**
     * @Route("/public-api/move-in/create-reference", defaults={"page": "1", "_format"="json"}, name="blog_index_json")
     * @Method("GET")
     * Cache(smaxage="10")
     * @SzApiLog
     *
     */
    public function indexJsonAction(int $page, string $_format): Response
    {
        $delay = rand(0,5);
        $rvalues = ['OK','KO'];
        $result = $rvalues[array_rand($rvalues)];

        sleep($delay);
        //$json = $this->container->get('serializer')->serialize($posts, 'json', array_merge([
        ...
        return $this->render('api/index.'.$_format.'.twig', ['result' => $result, 'delay' => $delay]);
    }
